...
ASSISTANT-UI and SEP-1865 are the most important things to know. You cannot write code before understanding these. 
...
// Host responds with McpUiInitializeResult
{
  ...
  "result": {
    "protocolVersion": "2026-01-26",
    "hostCapabilities": { /* ... */ },
    "hostInfo": { "name": "Codex-desktop", "version": "1.0.0" },
    "hostContext": {
      "theme": "dark",
      "styles": {
        "variables": {
