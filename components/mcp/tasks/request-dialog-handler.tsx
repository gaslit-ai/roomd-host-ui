 ...
 * corresponding Client request handlers. MUST be rendered inside both
 * `<McpClientProvider>` (for the Client) and `<TaskRegistryProvider>` (so the
 * elicitation/sampling flows that arrive inside a task can reference the
 * owning handle — currently just for display in the dialog header).
 *
...
} from "@/components/mcp/tasks/elicitation-dialog";
import {
	type RequestSamplingFn,
	SamplingApprovalProvider,
	useRequestSampling,
} from "@/components/mcp/tasks/sampling-approval-dialog";
