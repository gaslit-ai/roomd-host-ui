...
import { usePromptArgsDialog } from "@/components/assistant-ui/prompt-arguments-dialog";
import { SlashCommandPopover } from "@/components/assistant-ui/slash-command-popover";
import { TooltipIconButton } from "@/components/assistant-ui/tooltip-icon-button";
import { Button } from "@/components/ui/button";
import { useSlashCommandAdapter } from "@/lib/mcp/slash-command-adapter";
import { messageParts } from "@/lib/message-parts";
...
const Composer: FC = () => {
	const requestArgs = usePromptArgsDialog();
	const slashAdapter = useSlashCommandAdapter(requestArgs);
	return (
